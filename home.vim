...
set hlsearch
set nomodeline
set operatorfunc=<SNR>38_opfunc
...
set shortmess=aoO
badd +1 templates/home.pug
badd +1 staticfiles/css/sass/main.sass
badd +9 templates/base.pug
badd +1 staticfiles/js/es6/modules/home.js
badd +1 staticfiles/css/sass/home.sass
badd +11 ~/.vimrc
badd +1 staticfiles/css/sass/html.sass
badd +13 blogpython/models.py
badd +0 stock.json
badd +4 staticfiles/data/stock.json
badd +33 quantanalyst/settings/base.py
argglobal
silent! argdel *
argadd templates/home.pug
edit templates/base.pug
...
exe 'vert 1resize ' . ((&columns * 82 + 136) / 272)
exe '2resize ' . ((&lines * 41 + 42) / 85)
exe 'vert 2resize ' . ((&columns * 82 + 136) / 272)
exe 'vert 3resize ' . ((&columns * 87 + 136) / 272)
exe '4resize ' . ((&lines * 41 + 42) / 85)
exe 'vert 4resize ' . ((&columns * 48 + 136) / 272)
exe '5resize ' . ((&lines * 41 + 42) / 85)
exe 'vert 5resize ' . ((&columns * 48 + 136) / 272)
exe 'vert 6resize ' . ((&columns * 52 + 136) / 272)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/templates/home.pug
let s:cpo_save=&cpo
set cpo&vim
imap <buffer>  <Plug>SparkupExecute
imap <buffer>  <Plug>SparkupNext
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/js/es6/modules/home.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
2,21fold
33,88fold
let s:l = 127 - ((126 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
127
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/css/sass/home.sass
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 119 - ((79 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
119
