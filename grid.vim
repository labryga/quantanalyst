...
silent only
cd ~/quantanalyst/quantanalyst/staticfiles/css/sass
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +46 ~/quantanalyst/quantanalyst/staticfiles/gulp/gulpfile.js
badd +1 main.sass
badd +26 ~/quantanalyst/quantanalyst/templates/grid.pug
badd +14 mixins.sass
badd +1 footer.sass
badd +1 html.sass
badd +3 ~/quantanalyst/quantanalyst/staticfiles/js/es6/modules/navigation.js
badd +5 header.sass
argglobal
silent! argdel *
argadd ~/quantanalyst/quantanalyst/staticfiles/gulp/gulpfile.js
edit ~/quantanalyst/quantanalyst/staticfiles/js/es6/modules/navigation.js
...
exe 'vert 1resize ' . ((&columns * 140 + 136) / 272)
exe '2resize ' . ((&lines * 41 + 42) / 85)
exe 'vert 2resize ' . ((&columns * 140 + 136) / 272)
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/templates/grid.pug
let s:cpo_save=&cpo
set cpo&vim
...
18
normal! zo
let s:l = 84 - ((38 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
...
46,89fold
91,108fold
let s:l = 22 - ((21 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/css/sass/footer.sass
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((18 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
