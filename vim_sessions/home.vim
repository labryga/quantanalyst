...
badd +13 templates/baseAjax.pug
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/templates/baseAjax.pug
let s:cpo_save=&cpo
set cpo&vim
imap <buffer>  <Plug>SparkupExecute
imap <buffer>  <Plug>SparkupNext
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/templates/ext_list.pug
let s:cpo_save=&cpo
set cpo&vim
imap <buffer>  <Plug>SparkupExecute
imap <buffer>  <Plug>SparkupNext
