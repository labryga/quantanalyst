...
badd +51 ~/quantanalyst/quantanalyst/staticfiles/css/sass/header.sass
badd +25 ~/quantanalyst/quantanalyst/staticfiles/css/sass/main.sass
badd +46 ~/quantanalyst/quantanalyst/staticfiles/css/sass/mixins.sass
...
badd +17 ~/quantanalyst/quantanalyst/staticfiles/css/sass/navigation_desktop_tablet.sass
...
badd +0 navigation_phone.js
badd +0 navigation_desktop_tablet_xl.js
argglobal
silent! argdel *
...
exe '7resize ' . ((&lines * 24 + 42) / 85)
exe 'vert 7resize ' . ((&columns * 136 + 136) / 272)
tabedit ~/quantanalyst/quantanalyst/staticfiles/css/sass/main.sass
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
exe '2resize ' . ((&lines * 48 + 42) / 85)
exe 'vert 2resize ' . ((&columns * 49 + 136) / 272)
exe '3resize ' . ((&lines * 33 + 42) / 85)
exe 'vert 3resize ' . ((&columns * 49 + 136) / 272)
exe 'vert 4resize ' . ((&columns * 53 + 136) / 272)
exe 'vert 5resize ' . ((&columns * 54 + 136) / 272)
exe '6resize ' . ((&lines * 38 + 42) / 85)
exe 'vert 6resize ' . ((&columns * 58 + 136) / 272)
exe '7resize ' . ((&lines * 43 + 42) / 85)
exe 'vert 7resize ' . ((&columns * 58 + 136) / 272)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 27 - ((25 * winheight(0) + 41) / 82)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/css/sass/header.sass
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/css/sass/navigation_desktop_tablet.sass
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((16 * winheight(0) + 41) / 82)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/css/sass/mixins.sass
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
11
normal! zc
let s:l = 28 - ((26 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
