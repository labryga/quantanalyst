...
set shortmess=aoO
badd +1 staticfiles/css/sass/phone.sass
badd +1 staticfiles/css/sass/tablet.sass
badd +1 staticfiles/css/sass/tablet_xl.sass
...
badd +34 staticfiles/js/es6/modules/navigation.js
...
badd +6 templates/header.pug
badd +18 staticfiles/css/sass/footer.sass
badd +0 templates/BlogEntriesList.pug
badd +0 templates/BlogEntriesListAjax.pug
badd +0 templates/footer.pug
argglobal
silent! argdel *
argadd staticfiles/css/sass/phone.sass
set stal=2
edit staticfiles/css/sass/desktop.sass
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/css/sass/tablet_xl.sass
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/css/sass/tablet.sass
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/css/sass/phone.sass
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((57 * winheight(0) + 41) / 82)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/js/es6/modules/phone.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/js/es6/modules/tablet.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/staticfiles/js/es6/modules/desktop.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe '4resize ' . ((&lines * 27 + 42) / 85)
exe 'vert 4resize ' . ((&columns * 135 + 136) / 272)
tabedit ~/quantanalyst/quantanalyst/templates/BlogEntriesListAjax.pug
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 12 - ((8 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
...
wincmd w
argglobal
edit ~/quantanalyst/quantanalyst/templates/footer.pug
let s:cpo_save=&cpo
set cpo&vim
imap <buffer>  <Plug>SparkupExecute
imap <buffer>  <Plug>SparkupNext
