...
silent only
cd ~/quantanalyst/quantanalyst
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +28 templates/base.pug
badd +51 staticfiles/css/sass/header.sass
badd +25 staticfiles/css/sass/main.sass
...
badd +1 staticfiles/js/es6/modules/home.js
...
badd +3 templates/BlogEintrag.pug
badd +1 templates/BlogEintragList.pug
badd +1 staticfiles/js/production/quantanalyst.min.js
badd +15 staticfiles/js/es6/modules/navigation.js
badd +8 templates/navigation_desktop_tablet.pug
...
badd +1 templates/ext.pug
badd +1 templates/ext_list.pug
badd +1 templates/BlogEntriesListAjax.pug
badd +1 templates/BlogEntry.pug
badd +1 templates/BlogEntryAjax.pug
badd +1 templates/BlogEntriesList.pug
badd +1 apps/modellsimulation/models.py
badd +1 project_templates/models.py
badd +1 ~/.vimrc
badd +1 staticfiles/css/sass/navigation_tablet.sass
badd +299 ~/vimtime.txt
argglobal
silent! argdel *
argadd templates/base.pug
set stal=2
edit apps/home/urls.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((21 * winheight(0) + 44) / 89)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 20 + 46) / 92)
exe 'vert 1resize ' . ((&columns * 136 + 136) / 272)
exe '2resize ' . ((&lines * 20 + 46) / 92)
exe 'vert 2resize ' . ((&columns * 136 + 136) / 272)
exe '3resize ' . ((&lines * 41 + 46) / 92)
exe 'vert 3resize ' . ((&columns * 135 + 136) / 272)
exe '4resize ' . ((&lines * 20 + 46) / 92)
exe 'vert 4resize ' . ((&columns * 136 + 136) / 272)
exe '5resize ' . ((&lines * 20 + 46) / 92)
exe 'vert 5resize ' . ((&columns * 135 + 136) / 272)
exe '6resize ' . ((&lines * 26 + 46) / 92)
exe 'vert 6resize ' . ((&columns * 136 + 136) / 272)
exe '7resize ' . ((&lines * 26 + 46) / 92)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 116 - ((83 * winheight(0) + 45) / 90)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
116
