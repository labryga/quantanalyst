...
exe 'vert 4resize ' . ((&columns * 181 + 136) / 272)
exe 'vert 5resize ' . ((&columns * 90 + 136) / 272)
tabedit ~/quantanalyst/quantanalyst/quantanalyst/settings/base.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 43 - ((12 * winheight(0) + 41) / 83)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
