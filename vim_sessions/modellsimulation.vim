...
badd +0 templates/BlogEintrag.pug
badd +0 templates/BlogEintragAjax.pug
badd +0 staticfiles/js/es6/modules/navigation.js
badd +0 templates/BlogEintragList.pug
badd +0 ~/quantanalyst/lib/python3.5/site-packages/django/views/generic/detail.py
badd +116 ~/quantanalyst/lib/python3.5/site-packages/django/views/generic/base.py
badd +0 ~/quantanalyst/lib/python3.5/site-packages/django/template/response.py
badd +43 quantanalyst/settings/base.py
argglobal
silent! argdel *
argadd apps/modellsimulation/views.py
edit staticfiles/js/es6/modules/navigation.js
...
exe '1resize ' . ((&lines * 27 + 46) / 92)
exe 'vert 1resize ' . ((&columns * 130 + 136) / 272)
exe '2resize ' . ((&lines * 27 + 46) / 92)
exe 'vert 2resize ' . ((&columns * 130 + 136) / 272)
exe '3resize ' . ((&lines * 34 + 46) / 92)
exe 'vert 3resize ' . ((&columns * 130 + 136) / 272)
exe '4resize ' . ((&lines * 41 + 46) / 92)
exe 'vert 4resize ' . ((&columns * 141 + 136) / 272)
exe '5resize ' . ((&lines * 48 + 46) / 92)
exe 'vert 5resize ' . ((&columns * 75 + 136) / 272)
exe '6resize ' . ((&lines * 48 + 46) / 92)
exe 'vert 6resize ' . ((&columns * 65 + 136) / 272)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
46
normal! zo
let s:l = 43 - ((34 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
